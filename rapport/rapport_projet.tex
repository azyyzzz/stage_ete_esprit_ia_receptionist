...
\midrule
\endhead
PDF & \texttt{pdfplumber}, découpage par \texttt{Article~N~:} si la structure existe
(réutilise le même algorithme que \texttt{data/scripts/reextract\_reglements.py} --
retrait du sommaire, découpage des articles trop longs), sinon repli sur une fiche par
page. \\
